...
void BigHouseView::RenderScene() {
  ...
  SetupLight();
  glPushMatrix();
  glTranslatef(50.0, 0.0, 2.5f);
  DrawCad();
  glPopMatrix();

  glPushMatrix();
  glTranslatef(50.0, -120.0, 2.5f);
  DrawCad();
  glPopMatrix();

  glPushMatrix();
  glTranslatef(-260.0, 0.0, 2.5f);
  DrawCad();
  glPopMatrix();

  glPushMatrix();
  glTranslatef(-260.0, -120.0, 2.5f);
  DrawCad();
  glPopMatrix();
  DisableLight();
...
void BigHouseView::OnLoadTexture() {
  ...
  LoadTexture(str_path + L"\\bitmap\\wall.bmp",  0);
